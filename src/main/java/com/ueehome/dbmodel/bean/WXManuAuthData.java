...
public class WXManuAuthData {
     ...
     * @param enable       是否开启
     */
    public WXManuAuthData(String pid, String pidSub, Long prodDate, Long prodDeadline, Integer count, Integer usedCount, Boolean enable) {
        this.pid = pid;
        this.pidSub = pidSub;
